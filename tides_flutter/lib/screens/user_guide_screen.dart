...
class UserGuideScreen extends StatelessWidget {
  ...
  static const _sections = <_Section>[
    ...
    _Section(
      ...
      [
        'Tap the takeoff icon in the home screen toolbar to open the Before You Fly screen. It queries both the FAA\'s public airspace service and the National Park Service boundary data at your GPS location — no third-party apps, no account, no redirects.',
        'The map shows colored overlays for the entire visible area. Pan and zoom to explore nearby airspace and protected lands; the overlay updates as you move.',
        '• Solid red — Prohibited airspace (P): no drone operations allowed under any circumstances.',
        '• Lighter red — Restricted airspace (R): contact the controlling agency before flying.',
        '• Orange — Warning or Alert area: exercise caution.',
        '• Blue — Controlled airspace (Class B, C, or D): FAA authorization required before flying a drone.',
        '• Green — National Park Service unit (national park, seashore, monument, etc.): drones are prohibited in all NPS units under 36 CFR 1.5, regardless of FAA airspace class. A location can be in Class G (uncontrolled) airspace and still be illegal to fly in because of the NPS land-management rule.',
        'Tap anywhere on the map to check airspace at that exact point. A cyan pin drops on the tapped spot and the status card updates with the combined FAA + NPS result. Tap "My Location" to return to your GPS status.',
        'This screen is for quick reference only. Data comes from the FAA\'s public ArcGIS REST service and the NPS Land Resources Division boundary service. TFRs may not always appear — always confirm with the FAA NOTAM system before flying.',
      ],
    ),
    _Section(
