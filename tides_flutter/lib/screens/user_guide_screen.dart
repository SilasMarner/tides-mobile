  ...
  static const _sections = <_Section>[
    ...
    _Section(
      ...
      [
        ...
        '• Class G — uncontrolled airspace: no FAA authorization required. Fly under 400 ft AGL, keep the drone in sight, and stay clear of people, vehicles, and emergency scenes.',
        '• Controlled airspace (Class B, C, D, or E): FAA authorization is required before flying a drone. Contact the controlling facility or use FAA\'s LAANC system through an approved app.',
        '• Restricted or Prohibited: no drone operations allowed, or you must contact the controlling agency before flying.',
        'When the FAA returns airspace polygon data, the zone boundary is drawn directly on the map so you can see exactly where the controlled airspace begins and ends.',
