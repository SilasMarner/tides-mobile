...
class UserGuideScreen extends StatelessWidget {
  ...
  static const _sections = <_Section>[
    ...
    _Section(
      ...
      [
        'Tap the takeoff icon in the home screen toolbar to open the Before You Fly screen. It uses your GPS location to query the FAA\'s public airspace service directly — no third-party apps, no account, no redirects.',
        'The map shows colored airspace zone overlays for the entire visible area, not just your current spot. Pan and zoom to explore nearby airspace and the overlay updates automatically.',
        ...
        '• Blue — Controlled airspace (Class B, C, or D): FAA authorization required before flying a drone. Use the FAA\'s LAANC system through an approved app to request authorization.',
        'Tap anywhere on the map to check airspace at that exact point. A cyan pin drops on the tapped spot and the status card updates with the result for that location. Tap "My Location" in the card to return to your GPS status.',
        'This screen is for quick reference only. Airspace data comes from the FAA\'s public ArcGIS REST service. TFRs (Temporary Flight Restrictions) may not always appear — always confirm with the FAA NOTAM system before flying.',
      ],
    ),
    _Section(
