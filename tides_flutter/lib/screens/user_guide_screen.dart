  ...
  static const _sections = <_Section>[
    ...
    _Section(
      ...
      [
        ...
        '• Water Temp map — three satellite layers: the sea-surface temperature gradient, Upwelling (how far the water runs above/below normal), and Turbidity (clear vs. murky water). The data follows the map as you pan and zoom.',
