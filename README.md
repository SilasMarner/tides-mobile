...
| Trip list | Plan a trip | Weather & tide log |
|-----------|-------------|---------------------|
| ![Trip list](screenshots/trip_planner_list.png) | ![Trip form](screenshots/trip_planner_form.png) | ![Weather log](screenshots/trip_planner_weather_log.png) |
